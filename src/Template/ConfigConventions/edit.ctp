 ...
 * @var \App\Model\Entity\ConfigConvention $configConvention
 */
?>
<?php
...
?>
<div class="configConventions edit col-lg-12 col-md-12 columns content">
	<h1>
	<?= __('Edit Config Convention') ?>
	<?= $this->element('buttons',['controller'=>'configConventions','options'=>'index']) ?>
	</h1>
	<?php
	...
	?>
    <?= $this->Form->create($configConvention, ['horizontal' => true]) ?>
    <fieldset>
        
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('configConvention') ?></h3>        
        <?php
		...
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('configConvention') ?></h3>  
		<?php            echo $this->Form->control('ordre', ['class' => 'form-control','help' => __('')]);
        ?>
		</div>
    </fieldset>
