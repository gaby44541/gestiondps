 ...
 * @var \App\Model\Entity\ConfigTypepublic $configTypepublic
 */
?>
<?php
...
?>
<div class="configTypepublics edit col-lg-12 col-md-12 columns content">
	<h1>
	<?= __('Edit Config Typepublic') ?>
	<?= $this->element('buttons',['controller'=>'configTypepublics','options'=>'index']) ?>
	</h1>
	<?php
	...
	?>
    <?= $this->Form->create($configTypepublic, ['horizontal' => true]) ?>
    <fieldset>
        
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('configTypepublic') ?></h3>        
        <?php
