 ...
 * @var \App\Model\Entity\ConfigDelai $configDelai
 */
?>
<?php
...
?>
<div class="configDelais edit col-lg-12 col-md-12 columns content">
	<h1>
	<?= __('Edit Config Delai') ?>
	<?= $this->element('buttons',['controller'=>'configDelais','options'=>'index']) ?>
	</h1>
	<?php
	...
	?>
    <?= $this->Form->create($configDelai, ['horizontal' => true]) ?>
    <fieldset>
        
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('configDelai') ?></h3>        
        <?php
