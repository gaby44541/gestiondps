...
<div class="container-fluid">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('send', ['type'=>'datetimepicking','empty' => true,'class' => 'form-control','help' => __('')]);
            echo $this->Form->control('read', ['type'=>'datetimepicking','empty' => true,'class' => 'form-control','help' => __('')]);
		?>
		</div>
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('mailing') ?></h3>  
