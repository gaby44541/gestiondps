 ...
 * @var \App\Model\Entity\Wizard $wizard
 */
?>
<?php
...
?>
<div class="wizards edit col-lg-12 col-md-12 columns content">
	<h1>
	<?= __('Add Wizard') ?>
	<?= $this->element('buttons',['controller'=>'wizards','options'=>'index']) ?>
	</h1>
	<?php
	...
	?>
    <?= $this->Form->create($wizard, ['horizontal' => true]) ?>
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('step', ['class' => 'form-control','help' => __('')]);
            echo $this->Form->control('datas', ['class' => 'form-control','help' => __('')]);
		?>
		</div>
		<div class="col-lg-6 col-md-12 columns">
		<h3><?= __('wizard') ?></h3>  
