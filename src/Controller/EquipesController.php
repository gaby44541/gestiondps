...
class EquipesController extends AppController
{
    ...
    public function add($dispositif_id=0)
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('L\'équipe n\'a pas pu être sauvegardée. Merci de réessayer.'));
        }
    ...
    public function delete($id = null)
    {
		...
		if ($this->Equipes->delete($equipe)) {
            ...
            $this->Flash->error(__('L\'équipe n\'a pas pu être supprimée. Merci de réessayer.'));
        }
    ...
    public function duplicate($id = null)
    {
		...
		if ($this->Equipes->duplicate($id)) {
			$this->Flash->success(__('L\'équipe a été dupliquée.'));
        } else {
            $this->Flash->error(__('L\'équipe n\'a pas pu être supprimée. Merci de réessayer.'));
        }
